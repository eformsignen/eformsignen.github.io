...
2. Drag and drop the file onto the screen or click the **Select a file**
   ...
   .. figure:: resources/en-new-from-my-file-upload.png
      :alt: New from my file upload
      :width: 700px
...
The change field types feature allows you to change the type of an already-added field when designing forms online.

**Instructions**


1. When designing a form, right-click on the desired field and then select the ‘Change field type’ option.


2. Select the field type you want to change to.


.. figure:: resources/changefieldtypes.png
   :alt: Change field types
   :width: 1000px


※ This feature is not available in eformsign for Microsoft Office.
