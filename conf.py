...
html_favicon = 'C:\docbook\eformsignen.github.io\images\\favicon.ico'
...
texinfo_documents = [
    (master_doc, 'eformsignUserGuide', 'eformsign user guide',
...
html_short_title = "eformsign user guide"
...
html_theme_options = {
    ...
    "source_icon": "C:\Docbook\eformsignen.github.io\docs\_static\favicon.png",
    "banner_text": '<a href="https://www.eformsign.com/">Go to eformsign</a>'
}
...
pdf_documents = [
 ('index', u'My Documents', u'My Project', u'Author Name'),
]
