...
.. tip::
  ...
  **💡 How to select a notification language for each recipient step when using New from my file**

   1. Navigate to the ‘New from my file’ page.
   2. Upload a file and navigate to the ‘Add recipients’ step.
   3. Select a workflow step you want and then click the language symbol on the right.
   4. Select the language you want.
   5. Click the ‘Edit message’ button on the right under ‘Recipient options > Notification’.
   6. In the ‘Edit notification message’ pop-up displayed, view and edit the content in the selected language.
...
6. Click the **Options** step to change the document title and select whether to timestamp the document when completed.
   ...
   .. figure:: resources/optionstep.png
         :alt: Options step
         :width: 1200px
...
8. If you click the **Send** button after reviewing/filling in the document, then the document is sent to recipients.
   ...
   .. figure:: resources/senddocument.png
         :alt: Send document
         :width: 1200px
...
5. Fill in the recipient's name and contact information. If you want to change the language, then click the language button.

.. figure:: resources/changelanguage.png
   :alt: Change language
   :width: 500px
